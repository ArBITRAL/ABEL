-file("/usr/local/Cellar/erlang/21.0.4/lib/erlang/lib/parsetools-2.1.7/include/leexinc.hrl", 0).
...
-file("/usr/local/Cellar/erlang/21.0.4/lib/erlang/lib/parsetools-2.1.7/include/leexinc.hrl", 14).
...
-file("./scanner.erl", 332).
yystate() -> 37.

yystate(44, [62|Ics], Line, Tlen, _, _) ->
...
yystate(42, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(28, Ics, Line, Tlen+1, 7, Tlen);
yystate(42, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 47 ->
    yystate(28, Ics, Line, Tlen+1, 7, Tlen);
...
yystate(37, [63|Ics], Line, Tlen, _, _) ->
    yystate(29, Ics, Line, Tlen+1, 4, Tlen);
yystate(37, [62|Ics], Line, Tlen, _, _) ->
...
yystate(37, [42|Ics], Line, Tlen, _, _) ->
    yystate(29, Ics, Line, Tlen+1, 4, Tlen);
yystate(37, [41|Ics], Line, Tlen, _, _) ->
    yystate(29, Ics, Line, Tlen+1, 4, Tlen);
yystate(37, [40|Ics], Line, Tlen, _, _) ->
    yystate(29, Ics, Line, Tlen+1, 4, Tlen);
yystate(37, [39|Ics], Line, Tlen, _, _) ->
...
yystate(37, [10|Ics], Line, Tlen, _, _) ->
    yystate(41, Ics, Line+1, Tlen+1, 4, Tlen);
...
yystate(37, [C|Ics], Line, Tlen, _, _) when C >= 98, C =< 101 ->
    yystate(12, Ics, Line, Tlen+1, 4, Tlen);
yystate(37, [C|Ics], Line, Tlen, _, _) when C >= 103, C =< 109 ->
    yystate(12, Ics, Line, Tlen+1, 4, Tlen);
...
yystate(23, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(12, Ics, Line, Tlen+1, 7, Tlen);
yystate(23, [C|Ics], Line, Tlen, _, _) when C >= 98, C =< 101 ->
    yystate(12, Ics, Line, Tlen+1, 7, Tlen);
...
yystate(21, [124|Ics], Line, Tlen, _, _) ->
    yystate(29, Ics, Line, Tlen+1, 5, Tlen);
yystate(21, [94|Ics], Line, Tlen, _, _) ->
    yystate(29, Ics, Line, Tlen+1, 5, Tlen);
...
yystate(13, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 103 ->
    yystate(12, Ics, Line, Tlen+1, 7, Tlen);
yystate(13, [C|Ics], Line, Tlen, _, _) when C >= 105, C =< 113 ->
    yystate(12, Ics, Line, Tlen+1, 7, Tlen);
...
-file("./scanner.xrl", 8).
yyaction_0(TokenChars, TokenLine) ->
     { token, { tt, TokenLine, TokenChars } } .

-compile({inline,yyaction_1/2}).
-file("./scanner.xrl", 9).
yyaction_1(TokenChars, TokenLine) ->
     { token, { ff, TokenLine, TokenChars } } .
...
-file("./scanner.xrl", 27).
yyaction_8(TokenChars, TokenLen, TokenLine) ->
     { token, { atom, TokenLine, strip (TokenChars, TokenLen) } } .

-compile({inline,yyaction_9/3}).
-file("./scanner.xrl", 28).
yyaction_9(TokenChars, TokenLen, TokenLine) ->
     { token, { param, TokenLine, strip1 (TokenChars, TokenLen) } } .

-compile({inline,yyaction_10/3}).
-file("./scanner.xrl", 29).
yyaction_10(TokenChars, TokenLen, TokenLine) ->
     { token, { func, TokenLine, strip1 (TokenChars, TokenLen) } } .

-compile({inline,yyaction_11/3}).
-file("./scanner.xrl", 30).
yyaction_11(TokenChars, TokenLen, TokenLine) ->
     { token, { self, TokenLine, strip2 (TokenChars, TokenLen) } } .
...
-file("/usr/local/Cellar/erlang/21.0.4/lib/erlang/lib/parsetools-2.1.7/include/leexinc.hrl", 313).
